...
## 1. Team Stats
<img width="4150" height="2400" alt="nba_analytics_page-0001" src="https://github.com/user-attachments/assets/ebec98de-6628-4e03-b60a-cff922bf96aa" />
...
At first, I wanted to use the Player Efficiency Rating (PER), but since that formula was too complicated, I ended up using a simpler formula, which is EFF.
